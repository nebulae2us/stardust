 ...
 *
 */
public class ValueObjectDefinitionBuilder extends AttributeHolderDefinitionBuilder<ValueObjectDefinitionBuilder> {
	...
	public ValueObjectDefinitionBuilder(Class<?> owningEntityClass, String attributeFullName, Class<?> voClass) {
	...
	public ValueObjectDefinition toValueObjectDefinition() {
		return new Converter().convert(this).to(ValueObjectDefinition.class);
	}
