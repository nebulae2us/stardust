...
import org.nebulae2us.stardust.expr.domain.InsertExpression;
...
public class Insert {
	...
	public Insert(TranslatorContext translatorContext, InsertExpression insertExpression, ParamValues paramValues) {
	...
	public Pair<String, List<?>> translate() {
		...
		Translator translator = controller.findTranslator(this.insertExpression, this.paramValues);
		return translator.translate(this.translatorContext, this.insertExpression, this.paramValues);
	}
}
