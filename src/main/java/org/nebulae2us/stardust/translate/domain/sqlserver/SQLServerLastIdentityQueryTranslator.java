 ...
 */
package org.nebulae2us.stardust.translate.domain.sqlserver;
 ...
 *
 */
public class SQLServerLastIdentityQueryTranslator implements Translator {
	...
	public Pair<String, List<?>> translate(TranslatorContext context,
		...
		return new Pair<String, List<?>>("select scope_identity()", Immutables.emptyList());
	}
