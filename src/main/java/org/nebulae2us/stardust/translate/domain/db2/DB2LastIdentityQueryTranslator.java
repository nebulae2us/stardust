 ...
 *
 */
public class DB2LastIdentityQueryTranslator implements Translator {
	...
	public Pair<String, List<?>> translate(TranslatorContext context,
		...
		return new Pair<String, List<?>>("select identity_val_local() as val from sysibm.sysdummy1", Immutables.emptyList());
	}
